...
#   RHEL_UIDINVENTORY.dat   — unique UIDs across all hosts (sorted numerically)
#   RHEL_GIDINVENTORY.dat   — unique GIDs across all hosts (sorted numerically)
...
#   hostname-USER-user:uid,gid,...
#   hostname-GROUP-group,...
#   hostname-NETGROUP-netgroup,...
#   hostname-ADGROUP-adgroup,...
# =============================================================================
...
# In test mode use TEST_DATA dir, otherwise use DATA_DIR
...
# =============================================================================
# UID collection — parse hostname-USER- lines
# Format: hostname-USER-username:uid,gid,...
# Extract uid (field after last colon before comma), print "uid username"
# =============================================================================
...
# =============================================================================
# GID collection — parse hostname-GROUP- lines
# Format: hostname-GROUP-groupname:gid,...
# =============================================================================
grep "\-GROUP\-" "$_IDDATA" | while read -r IDLIST; do
    H="${IDLIST/-*}"
    IDLIST="${IDLIST/*-GROUP-}"
    IDLIST="${IDLIST//,/ }"
    for ID in $IDLIST; do
...
# =============================================================================
# Netgroup collection — parse hostname-NETGROUP- lines
# =============================================================================
...
# =============================================================================
# AD group collection — parse hostname-ADGROUP- lines
# =============================================================================
